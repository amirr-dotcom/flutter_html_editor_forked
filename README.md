...
For the full API reference, see [here](https://pub.dev/documentation/flutter_html_editor_forked/latest/).
...
Every callback is defined as a `Function(<parameters in some cases>)`. See the [documentation](https://pub.dev/documentation/flutter_html_editor_forked/latest/) for more specific details on each callback.
...
```html
<script src="assets/packages/flutter_html_editor_forked/assets/jquery.min.js"></script>
<link href="assets/packages/flutter_html_editor_forked/assets/summernote-lite.min.css" rel="stylesheet">
<script src="assets/packages/flutter_html_editor_forked/assets/summernote-lite.min.js"></script>
```
...
#   f l u t t e r _ h t m l _ e d i t o r 
 
 #   f l u t t e r _ h t m l _ e d i t o r _ f o r k e d  
 