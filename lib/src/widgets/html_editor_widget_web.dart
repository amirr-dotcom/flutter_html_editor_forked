...
import 'package:flutter_html_editor_forked/utils/shims/dart_ui.dart' as ui;
...
class _HtmlEditorWidgetWebState extends State<HtmlEditorWidget> {
  ...
  void initSummernote() async {
    ...
    if ((Theme.of(widget.initBC).brightness == Brightness.dark ||
      ...
      darkCSS =
          '<link href=\"assets/packages/flutter_html_editor_forked/assets/summernote-lite-dark.css\" rel=\"stylesheet\">';
    }
    var jsCallbacks = '';
    if (widget.callbacks != null) {
    ...
    """;
    var filePath =
        'packages/flutter_html_editor_forked/assets/summernote-no-plugins.html';
    ...
    htmlString = htmlString
        ...
        .replaceFirst('"jquery.min.js"',
            '"assets/packages/flutter_html_editor_forked/assets/jquery.min.js"')
        .replaceFirst('"summernote-lite.min.css"',
            '"assets/packages/flutter_html_editor_forked/assets/summernote-lite.min.css"')
        .replaceFirst('"summernote-lite.min.js"',
            '"assets/packages/flutter_html_editor_forked/assets/summernote-lite.min.js"');
