...
import 'package:flutter_html_editor_forked/src/html_editor_controller_unsupported.dart'
    as unsupported;
...
class HtmlEditorController extends unsupported.HtmlEditorController {
  ...
  void reloadWeb() {
    throw Exception(
        'Non-Flutter Web environment detected, please make sure you are importing package:flutter_html_editor_forked/html_editor.dart and check kIsWeb before calling this function');
  }
  ...
  dynamic _evaluateJavascript({required source}) async {
    if (!kIsWeb) {
      ...
      throw Exception(
          'Flutter Web environment detected, please make sure you are importing package:flutter_html_editor_forked/html_editor.dart');
    }
  }
